...
import {
  ...
  toggleDownvote,
  toggleUpvote,
} from "redux/reducers/postCommentsReducer";
import { fixUrl, prettifyLink, trimLink } from "utils/formatUrl";
import getErrorMsg from "utils/getErrorMsg";
import CommentInput from "components/comment/CommentInput";
import CommentsDisplay from "components/comment/CommentsDisplay";
import EditDeleteMenu from "components/menus/EditDeleteMenu";
import ErrorPage from "./ErrorPage";
import LoadingSpinner from "components/others/LoadingSpinner";
import SortCommentsMenu from "components/comment/SortCommentsMenu";
        ...
        <div className={classes.topPortion}>
          ...
          <div className={classes.postDetails}>
            <Typography variant="subtitle2">
              <Link component={RouterLink} to={`/c/${subreddit.subredditName}`}>
                {`c/${subreddit.subredditName} `}
              </Link>
